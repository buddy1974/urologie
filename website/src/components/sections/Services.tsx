...
const content = {
  de: {
    ...
    services: [
      ...
      { key: "urolift", title: "UroLift®", desc: "Schonende Behandlung der gutartigen Prostatavergrößerung ohne Operation.", image: "/assets/leistungen_003.jpg" },
  ...
  en: {
    ...
    services: [
      ...
      { key: "urolift", title: "UroLift®", desc: "Gentle treatment of benign prostate enlargement without surgery.", image: "/assets/leistungen_003.jpg" },
  ...
  fr: {
    ...
    services: [
      ...
      { key: "urolift", title: "UroLift®", desc: "Traitement doux de l'hypertrophie bénigne de la prostate sans opération.", image: "/assets/leistungen_003.jpg" },
