...
const RESULTS: LabResult[] = [
  { id:"1", patient:"Müller, Hans", test:"PSA", value:"5.8", unit:"ng/ml", refMin:0, refMax:4, numericValue:5.8, date:"23.03.2026", status:"high", doctor:"Dr. Fomuki", sent:false },
  { id:"2", patient:"Weber, Klaus", test:"PSA", value:"0.12", unit:"ng/ml", refMin:0, refMax:4, numericValue:0.12, date:"23.03.2026", status:"normal", doctor:"Dr. Fomuki", sent:true },
  { id:"3", patient:"Papadopoulos, Dimitri", test:"PSA", value:"6.2", unit:"ng/ml", refMin:0, refMax:4, numericValue:6.2, date:"23.03.2026", status:"critical", doctor:"Dr. Fomuki", sent:false },
  { id:"4", patient:"Fischer, Jürgen", test:"Kreatinin", value:"1.1", unit:"mg/dl", refMin:0.7, refMax:1.2, numericValue:1.1, date:"23.03.2026", status:"normal", doctor:"Dr. Fomuki", sent:true },
  { id:"5", patient:"Yilmaz, Mehmet", test:"Leukozyten Urin", value:"+++", unit:"", refMin:0, refMax:0, numericValue:3, date:"23.03.2026", status:"high", doctor:"Dr. Nwankwo", sent:false },
  { id:"6", patient:"Wagner, Stefan", test:"Testosteron", value:"2.1", unit:"ng/ml", refMin:2.8, refMax:8.0, numericValue:2.1, date:"23.03.2026", status:"low", doctor:"Dr. Fomuki", sent:false },
  { id:"7", patient:"Schmidt, Thomas", test:"Spermiogramm", value:"18 Mio/ml", unit:"", refMin:0, refMax:0, numericValue:18, date:"22.03.2026", status:"normal", doctor:"Dr. Fomuki", sent:true },
  { id:"8", patient:"Klein, Andreas", test:"Urinkultur", value:"E.coli >100.000", unit:"KBE/ml", refMin:0, refMax:0, numericValue:3, date:"22.03.2026", status:"critical", doctor:"Dr. Nwankwo", sent:false },
];
            ...
            <div key={r.id} className="bg-white rounded-2xl border border-slate-100 hover:shadow-sm transition-all p-3 md:p-4 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  {r.status==="critical" && <span className="text-xs px-2 py-0.5 rounded-full font-bold text-white" style={{backgroundColor:"#dc2626"}}>KRITISCH</span>}
                </div>
