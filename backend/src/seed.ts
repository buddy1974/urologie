...
async function seed() {
  ...
  const insertedPatients = await db.insert(patients).values([
    ...
    { firstName:"Mehmet",   lastName:"Yilmaz",         dateOfBirth:"1968-05-03", insurance:"GKV", phone:"0176-4567890",                               conditions:["Harnwegsinfekt","Diabetes"],    doctor:"Dr. Fomuki" },
    ...
    { firstName:"Andreas",  lastName:"Klein",          dateOfBirth:"1971-02-14", insurance:"GKV", phone:"0152-6789012",                               conditions:["Harnsteine"],                   doctor:"Dr. Fomuki" },
    ...
    { firstName:"Robert",   lastName:"Zimmermann",     dateOfBirth:"1978-04-07", insurance:"PKV", phone:"0176-2345601",                               conditions:["Inkontinenz","Magnetstimulation"],doctor:"Dr. Fomuki" },
    { firstName:"Frank",    lastName:"Becker",         dateOfBirth:"1965-10-18", insurance:"GKV", phone:"0164-8901234",                               conditions:["Vorsorge","PSA normal"],        doctor:"Dr. Fomuki" },
  ...
  const insertedAppts = await db.insert(appointments).values([
    ...
    { patientName:"Mehmet Yilmaz",         date:today, time:"09:30", duration:20, type:"Kontrolltermin",      doctor:"Dr. Fomuki", status:"arrived",     insurance:"GKV", room:"3", phone:"0176-4567890" },
    ...
    { patientName:"Andreas Klein",         date:today, time:"10:30", duration:15, type:"Laborergebnis",       doctor:"Dr. Fomuki", status:"scheduled",   insurance:"GKV", phone:"0152-6789012" },
    ...
    { patientName:"Frank Becker",          date:today, time:"11:30", duration:20, type:"Vorsorge Mann",       doctor:"Dr. Fomuki", status:"scheduled",   insurance:"GKV", phone:"0164-8901234" },
    ...
    { patientName:"Robert Zimmermann",     date:today, time:"15:30", duration:20, type:"Magnetstimulation",   doctor:"Dr. Fomuki", status:"scheduled",   insurance:"PKV", phone:"0176-2345601" },
  ]).returning();
  ...
  const insertedLab = await db.insert(labResults).values([
    ...
    { patientName:"Yilmaz, Mehmet",         test:"Leukozyten Urin",value:"+++",           unit:"",        refMin:"0", refMax:"0", status:"high",     doctor:"Dr. Fomuki", resultDate:today, sent:false },
    ...
    { patientName:"Klein, Andreas",         test:"Urinkultur",     value:"E.coli >100.000",unit:"KBE/ml", refMin:"0", refMax:"0", status:"critical", doctor:"Dr. Fomuki", resultDate:today, sent:false },
  ]).returning();
